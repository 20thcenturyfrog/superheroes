...
document.addEventListener("DOMContentLoaded", function (event) {
  ...
  for (let superhero of superheroes) {
    allCards += `
    <div class="card-star-wrapper">
    <div class="card">
    <div class="card-content">
    <div class="card-front">
    <h3 class="name">${superhero.name}</h3>
    <div class="feature"><b>Вселенная:</b> ${superhero.universe}</div>
    <div class="feature"><b>Альтер-эго:</b> ${superhero.alterego}</div>
    <div class="feature"><b>Род деятельности:</b> ${superhero.occupation}</div>
    <div class="feature"><b>Друзья:</b> ${superhero.friends}</div>
    <div class="feature"><b>Суперспособности:</b> ${superhero.superpowers}</div>
    <img class="image" src="${superhero.url}">
    </div>
    <div class="card-back">
    <div class="info"><b>Описание:</b> ${superhero.info}</div>
    </div>
    </div>
    </div>
    <div class="ratings-wrapper">
    <div data-cardid="${superhero.id}" class="ratings">
  ...
  document.getElementById("card-container").innerHTML = allCards;

  let resetButton = document.createElement("button");
  resetButton.innerText = "Очистить оценки";
...
function rateCard() {
  ...
  let cards = document.querySelectorAll(".ratings");
  let ratings = [];
  ...
  if (localStorage.getItem("rating")) {
    ...
    for (let rating of ratings) {
      for (let card of cards) {
        if (card.dataset.cardid == rating["card-id"]) {
          let reverse = Array.from(card.children).reverse();
